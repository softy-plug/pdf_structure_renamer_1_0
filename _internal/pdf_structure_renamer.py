...
def rename_video_files():
    ...
    for filename in os.listdir(current_directory):
        # Check if the file is an .pdf file
        if filename.endswith('.pdf'):
            # Strip the .pdf extension for processing
...
input("Структура PDF создана. Нажмите Enter для закрытия окна")
